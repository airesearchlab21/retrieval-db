...
\item {\bf Claims}
    ...
    \item[] Justification: The abstract and introduction claim a conformance-gated local decision audit tied to a recorded experimental profile; Figure~\ref{fig:decision-surface}, Tables~\ref{tab:portable-main-results} and~\ref{tab:portable-decision-table}, and the appendix claim-evidence map provide the supporting evidence.

\item {\bf Limitations}
    \item[] Question: Does the paper discuss the limitations of the work performed by the authors?
    \item[] Answer: \answerYes{}.
    \item[] Justification: The manuscript includes an experimental-boundaries section describing the recorded CPU-only setting, S3 multi-evidence corpus, S2 streaming post-insert retrievability metric, adapter settings, and budget-stability results.
...
\item {\bf Experimental result reproducibility}
    ...
    \item[] Answer: \answerYes{}.
    \item[] Justification: The appendix and supplementary material describe the workflow, validation summary, runtime metadata, checksums, conformance matrix, generated reports, and consistency verifier.
...
\item {\bf Open access to data and code}
    ...
    \item[] Answer: \answerYes{}.
    \item[] Justification: The benchmark code, workflow instructions, generated manifests, and frozen evaluation snapshot are part of the supplementary package prepared with this manuscript; any public release should preserve anonymization at submission time.
...
\item {\bf Experiment statistical significance}
    ...
    \item[] Answer: \answerYes{}.
    \item[] Justification: The main table reports 95\% confidence intervals; targeted S2 streaming and S3 multi-evidence audits report paired bootstrap intervals for the highest-risk margins, and Figure~\ref{fig:s3-paired-audit} visualizes the S3 multi-evidence paired interval.
...
\item {\bf Experiments compute resources}
    ...
    \item[] Answer: \answerYes{}.
    \item[] Justification: The benchmark-design and reproducibility sections state the CPU-only runtime profile and exact budget ladder; the run metadata records per-run resource fields.
...
\item {\bf Broader impacts}
    ...
    \item[] Answer: \answerYes{}.
    \item[] Justification: The experimental-boundaries and broader-impact section discusses the benefit of transparent deployment evidence with visible quality, post-insert retrievability, objective, budget, and margin information.
...
\item {\bf Licenses for existing assets}
    ...
    \item[] Answer: \answerYes{}.
    \item[] Justification: The manuscript cites the datasets, software systems, and embedding models used; final submission should include license manifests alongside the supplementary material.

\item {\bf New assets}
    \item[] Question: Are new assets introduced in the paper well documented and is the documentation provided alongside the assets?
    \item[] Answer: \answerYes{}.
    \item[] Justification: \hotpotmaxionbench{} is documented through its preprocessing description, manifest, checksums, validation summary, and Croissant-style metadata included with the supplementary material.
