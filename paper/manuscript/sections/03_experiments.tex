...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{../figures/portable_decision_surface.svg}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.62\linewidth]{../figures/portable_mvd_sensitivity.svg}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.72\linewidth]{../figures/s3_paired_audit_forest.svg}
  \caption{Matched S3 multi-evidence paired audit. Against FAISS exact FlatIP on the same 5{,}000 bge-base queries, pgvector IVF32 and IVF64 have paired \ecov{} deltas whose 95\% intervals include zero, so the aggregate pgvector quality-first row is indistinguishable under matched queries.}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.62\linewidth]{../figures/portable_budget_stability.svg}
